...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	activity.displayBitmap(pathBundle.getString(DownloadUtils.PATHNAME_KEY));
            }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent downloadService = ThreadPoolDownloadService.makeIntent(this, handler, getUrlString());
