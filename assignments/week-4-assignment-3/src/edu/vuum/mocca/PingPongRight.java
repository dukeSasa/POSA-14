...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        private String stringPingOrPong;
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore sSemaphores[] = new SimpleSemaphore[2];
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	stringPingOrPong = stringToPrint;
        	sSemaphores[FIRST_SEMA] = semaphoreOne;
        	sSemaphores[SECOND_SEMA] = semaphoreTwo;
        }
        ...
        public void run() {
        	...
        	for (int i = 1; i <= mMaxLoopIterations; i++){
        		acquire();
        		System.out.println(stringPingOrPong + "(" + i + ")");
        		release();
        	}
        	mLatch.countDown();
        }
        ...
        private void acquire() {
            // TODO fill in here
			sSemaphores[FIRST_SEMA].acquireUninterruptibly();
        }
        ...
        private void release() {
            // TODO fill in here
        	sSemaphores[SECOND_SEMA].release();
        }
    }
